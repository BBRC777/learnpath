        ...
        <div className="app-topbar" style={{ borderBottom:'1px solid var(--border)', background:'var(--bg2)', flexShrink:0, position:'sticky', top:0, zIndex:40 }}>
          ...
          <div style={{ padding:'0 12px', display:'flex', alignItems:'center', justifyContent:'space-between', minHeight:48, gap:8 }}>
            <div style={{ display:'flex', alignItems:'center', gap:10, flexShrink:0 }}>
              <button onClick={() => setSidebarOpen(o => !o)} style={{ width:32, height:32, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:5, background:'none', border:'none', cursor:'pointer', padding:4, borderRadius:6, flexShrink:0 }}>
                <div style={{ width:18, height:2, background:'var(--text3)', borderRadius:1 }}/>
                <div style={{ width:18, height:2, background:'var(--text3)', borderRadius:1 }}/>
                <div style={{ width:18, height:2, background:'var(--text3)', borderRadius:1 }}/>
              </button>
              <div style={{ fontFamily:'var(--sans)', fontSize:15, fontWeight:500, color:'var(--text)', whiteSpace:'nowrap' }}>
