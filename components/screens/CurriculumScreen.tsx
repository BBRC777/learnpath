...
<div style={{ display:'flex', gap:8, marginBottom:16 }}>
          <div onClick={() => setSelectedPlan('annual')} style={{ flex:1, padding:'12px 10px', borderRadius:10, background: selectedPlan==='annual' ? 'rgba(212,133,58,0.15)' : 'var(--bg3)', border: selectedPlan==='annual' ? '2px solid var(--amber)' : '1px solid var(--border)', textAlign:'center' as const, position:'relative' as const, cursor:'pointer' }}>
          ...
          <div onClick={() => setSelectedPlan('monthly')} style={{ flex:1, padding:'12px 10px', borderRadius:10, background:'var(--bg3)', border: selectedPlan==='monthly' ? '2px solid var(--text2)' : '1px solid var(--border)', textAlign:'center' as const, cursor:'pointer' }}>
